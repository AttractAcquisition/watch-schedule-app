export function WatchTodayCard() {
  ...
  const todays = [
    ["Deck/OOW Watch", "Chief Officer Sarah Mills", "20:00-00:00"],
    ["Interior Watch", "Second Stew Lisa Green", "20:00-00:00"],
    ["Engineering OOW", "Chief Engineer Marco Rossi", "20:00-00:00"],
  ];
  return (
